    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="<?= base_url() ?>dashboard" class="logo">
                ...
                <span class="logo-mini"><b><?= $this->session->userdata('company_name'); ?></b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b><?= $this->session->userdata('company_name'); ?></b></span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="javascript:void(0);" class="btn btn-default btn-flat btn_change_password">Password</a>
                                        <a href="javascript:void(0);" class="btn btn-default btn-flat btn_change_company">Company</a>
                                    </div>
