        ...
        <div class="login-box-body">
            ...
            <form action="../../index2.html" method="post">
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" placeholder="Contact Number" required data-inputmask='"mask": "99999-99999"' data-mask>
            ...
            <!-- <a href="login/forgot">I forgot my password</a><br> -->
            <a href="<?= base_url() ?>login" class="text-center">Go To Login</a>
